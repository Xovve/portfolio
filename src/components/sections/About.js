...
const About = props => {
  const translations = {
    pol: {
      ...
      text2:
        "Nazywam się Maciek, jestem Front-end Web Developerem (Tworzę interfejsy aplikacji i stron internetowych po stronie klienta, które widzi końcowy użytkownik). Specjalizuję się w tworzeniu nowoczesnych, responsywnych interfejsów opartych na technologii ",
      text3: " oraz ",
      text4:
        ". Potrafię także tworzyć podstawowe motywy do Systemu Zarządzania Treścią Wordpress oraz modyfikować przestarzały kod CSS na responsywny i odpowiedni dla smarfonów."
    },
    eng: {
      ...
      text3: " and ",
      text4:
        " technologies. I can also create basic themes for Wordpress Content Managment System as well as modify outdated website CSS into a mobile-friendly responsive styling."
    }
  };
  return (
    <div className="about">
      <div className="container about__container">
        <img className="about__image" src={face} />
        <div className="data">
